...
public slots:       // limited to the values fundamental data types may take
    void addContact();
    void submitContact();
    void cancel();
...
//! [findContact() declaration]
    void findContact();                     // declare public slot findcontact()
//! [findContact() declaration]
    void next();
    void previous();
...
//! [findButton declaration]
    QPushButton *findButton;                // add find button
//! [findButton declaration]
...
//! [FindDialog declaration]
    FindDialog *dialog;                     // used to refer to an instance of FindDialog
//! [FindDialog declaration]
