...
//! [disabling navigation]
    nextButton->setEnabled(false);              // dis-allow use while using addcontact
    previousButton->setEnabled(false);          // dis-allow use while using addcontact
//! [disabling navigation]
...
//! [enabling navigation]
    ...
    nextButton->setEnabled(number > 1);     // enable button if contact is greater then one
    previousButton->setEnabled(number > 1); // enable button if contact is greater then one
//! [enabling navigation]
...
void AddressBook::cancel()
{
    ...
    submitButton->hide();                       // i dont know why this is here
    cancelButton->hide();                       // i dont know why this is here
}
