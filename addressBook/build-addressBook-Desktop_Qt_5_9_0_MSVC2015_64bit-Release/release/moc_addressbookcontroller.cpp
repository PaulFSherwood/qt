...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_AddressBookController_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AddressBookController_t qt_meta_stringdata_AddressBookController = {
    {
QT_MOC_LITERAL(0, 0, 21) // "AddressBookController"
...
const QMetaObject AddressBookController::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_AddressBookController.data,
      qt_meta_data_AddressBookController,  qt_static_metacall, nullptr, nullptr}
};
...
void *AddressBookController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AddressBookController.stringdata0))
        return static_cast<void*>(const_cast< AddressBookController*>(this));
